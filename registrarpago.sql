...
CALL registrar_transaccion(pSenderName,pMerchant,pAmount,pCurrencySymbol,pDescription,pXTreamPercentage,pComputerName,pIPAddress,pTransactionType,1);
...
CALL registrar_pago('julioprofetv','PayPal',20.0,'$','this is a transaction',5.0,'AlePC','127.0.0.1','subscription',0)
